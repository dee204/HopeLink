<%-- 
    Document   : ViewMessagesFundraiser
    Created on : 9 Jun 2026, 5:39:55 PM
    Author     : farajuhaimi
--%>
...
<%
    ...
    if ("READ".equalsIgnoreCase(filter)) {
        notifications = NotificationDAO.getNotificationsByRoleAndStatus("FUNDRAISER", "READ");
    } else if ("UNREAD".equalsIgnoreCase(filter)) {
        notifications = NotificationDAO.getNotificationsByRoleAndStatus("FUNDRAISER", "UNREAD");
    } else {
        notifications = NotificationDAO.getNotificationsByRole("FUNDRAISER");
        filter = "ALL";
    }
%>
...
<div class="container">
    ...
    <form method="get" action="ViewMessagesFundraiser.jsp">
            ...
            <div class="notification-item">
                ...
                <% if ("UNREAD".equalsIgnoreCase(status)) { %>
                    <form action="NotificationServlet" method="post">
                        ...
                        <input type="hidden" name="returnPage" value="ViewMessagesFundraiser.jsp">
