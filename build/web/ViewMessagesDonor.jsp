<%-- 
    Document   : ViewMessagesDonor
    Created on : 31 Dec 2025, 8:03:33 PM
    Author     : farajuhaimi
--%>
...
<%
    ...
    if ("READ".equalsIgnoreCase(filter)) {
        notifications = NotificationDAO.getNotificationsByRoleAndStatus("DONOR", "READ");
    } else if ("UNREAD".equalsIgnoreCase(filter)) {
        notifications = NotificationDAO.getNotificationsByRoleAndStatus("DONOR", "UNREAD");
    } else {
        notifications = NotificationDAO.getNotificationsByRole("DONOR");
        filter = "ALL";
    }
%>
...
<div class="container">
    ...
    <form method="get" action="ViewMessagesDonor.jsp">
