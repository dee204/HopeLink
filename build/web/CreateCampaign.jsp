<%-- 
    ...
    Created on : 31 Dec 2025, 7:42:44 PM
    Author     : farajuhaimi
--%>
...
<head>
    <meta charset="UTF-8">
    <title>HopeLink | Create Campaign</title>
    <style> 
        :root { --pink-theme: #ffd1dc; 
               --soft-white: #fef9f9; 
               --charcoal: #333333; 
...
<header>
    ...
    <div class="header-center">CAMPAIGN SETTINGS</div>
