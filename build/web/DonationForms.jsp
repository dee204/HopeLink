<%-- 
    Document   : DonationForms
    Created on : 31 Dec 2025, 9:29:53 PM
    Author     : farajuhaimi
--%>
...
<head>
    <meta charset="UTF-8">
    <title>HopeLink | Donation Forms</title>
    <style>
        :root {
            --pink-theme: #ffd1dc;
            --soft-white: #fef9f9;
...
<%@ include file="DonorSidebar.jsp" %>
    <header>
        ...
        <div class="header-center">DONATION FORMS</div>
    ...
    <div class="container">
        ...
        <form action="DonorUpdateProfileServlet" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="amount" name="amount" placeholder="RMXXXXX" required>
            </div>
            <button type="button" class="btn-update" onclick="window.location.href='Payments.jsp'">
             Proceed Payment
             </button>
        </form>
    </div>
