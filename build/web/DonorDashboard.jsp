<%-- 
    ...
    Created on : 31 Dec 2025, 4:56:32 PM
    Author     : farajuhaimi
--%>
...
<head>
    <meta charset="UTF-8">
    <title>HopeLink | Donor Dashboard</title>
    <style>
        :root {
    ...
    <div class="dashboard-container">
        ...
        <div class="dashboard-grid">
            <div class="dash-card">
                ...
                <a href="DonorProfile.jsp">Edit Profile</a>
            </div>

            <div class="dash-card">
                <h3>Browse Campaign</h3>
                <div class="card-icon">🔍</div>
                <p>See list of all campaigns</p>
                <a href="BrowseCampaigns.jsp">View Campaigns</a>
            </div>
            <div class="dash-card">
                <h3>Donations History</h3>
                <div class="card-icon">📜</div>
                <p>See list of donation history</p>
                <a href="DonationHistory.jsp">View Donations</a>
            </div>
        </div>
        ...
        <div class="bottom-grid">
            ...
            <div class="dash-card">
                ...
                <a href="ViewMessagesDonor.jsp">View Messages</a>
            </div>
        </div>
    </div>
