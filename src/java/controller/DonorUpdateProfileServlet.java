 ...
 * @author farajuhaimi
 */
public class DonorUpdateProfileServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        if (success) {
            ...
            res.sendRedirect("DonorDashboard.jsp?update=success");
        } else {
            res.sendRedirect("DonorProfile.jsp?update=fail");
        }
    }
}