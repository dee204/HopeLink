<%-- 
    ...
    Created on : 31 Dec 2025, 4:56:45 PM
    Author     : farajuhaimi
--%>
...
<head>
    <meta charset="UTF-8">
    <title>HopeLink | Manager Dashboard</title>
    <style>
        :root {
...
<body>
<%@ include file="ManagerReportChatbot.jsp" %>
    <header>
        <div class="logo">
            <a href="HomePage.jsp">
    ...
    <div class="dashboard-container">
        ...
        <div class="dashboard-grid">
            <div class="dash-card">
                ...
                <p>See list of all registered accounts</p>
                <a href="ViewListAccounts.jsp">View List Accounts</a>
            </div>

            <div class="dash-card">
                <h3>Campaign Approval</h3>
                <div class="card-icon">📢</div>
                <p>See list of all campaigns approval</p>
                <a href="ViewCampaignsApproval.jsp">View List Campaigns</a>
            </div>

            <div class="dash-card">
                <h3>Analytical Reports (Fund)</h3>
                <div class="card-icon">📊</div>
                <p>Report showing total donated funds</p>
                <a href="ViewFundReports.jsp">View Fund Reports</a>
            </div>
        </div>

        <div class="bottom-grid">
            <div class="dash-card">
                <h3>Analytical Reports (Campaign)</h3>
                <div class="card-icon">📈</div>
                <p>Report showing all the active campaigns</p>
                <a href="ViewCampaignReports.jsp">View Campaign Reports</a>
            </div>

            <div class="dash-card">
                <h3>Messages</h3>
                <div class="card-icon">💬</div>
                <p>Check notifications and updates</p>
                <a href="ViewMessagesManager.jsp">View Messages</a>
            </div>
        </div>
    </div>
